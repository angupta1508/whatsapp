...
const Login = () => {
    ...
    const formSubmit = async (e) => {
        e.preventDefault();
        try {
            // const data = await axios.post(`${process.env.SERVER_URL}/login`,formData)
                        ...
                        <div className="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                            <form onSubmit={formSubmit}>
                                ...
                                <div data-mdb-input-init className="form-outline mb-4">
                                    ...
                                    <input type="email" id="email" name='email' className="form-control form-control-lg" placeholder="Enter a valid email address" onChange={onInputHandler} />
